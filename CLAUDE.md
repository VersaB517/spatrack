...
- **The extraction prompt has self-corrections** ("Wait — CORRECTION:") baked into the single-price-column rule. Edit carefully — vendor profiles override these general rules.
